"use client";
import { REVIEW_STATUSES, fmtCompact, type ExpenseTransaction } from "@/data/expenses";
...
export default function ExpenseSummaryCards({ data, isMobile, isTablet }: ExpenseSummaryCardsProps) {
