...
export default function HeroSection() {
  // Menghapus Smart CSV Mapper, menambahkan Vendor, dan translate ke Indo
  const marqueeItems = [
    "Deteksi Fraud Expense", "Intelijen Procurement", "Analisis Risiko Vendor",
    "Pantauan Vendor", "Laporan Audit AI", "Isolasi Forest",
    "Grafik Konflik Kepentingan", "Benchmark e-Katalog LKPP",
  ];
  ...
  return (
    <>
      ...
      <section className="hero-section">
        ...
        {/* Sub - Diubah hanya fokus ke CSV */}
        <p className="hero-sub">
          Upload data CSV atau isi form manual — Machine Learning Fradara langsung menganalisis transaksi dan vendor Anda, memberikan fraud score secara instan.
        </p>

        {/* CTAs - Button primary ke /login, Button demo ke web eksternal */}
        <div className="hero-cta hero-cta-wrap">
          <Link href="/login" className="btn-primary hero-btn-primary">
          ...
          <a href="https://link-demo-nanti-disini.com" target="_blank" rel="noopener noreferrer" className="btn-ghost hero-btn-ghost">
